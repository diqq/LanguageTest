        ...
        <?php $__currentLoopData = $exams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="w-5/12 p-5 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <h1
                    ...
                    STARTING
                    <?php echo e($exam->category == 'ept' ? 'EPT' : 'TOEIC'); ?>
                ...
                <div class="flex justify-between mt-5">
                    ...
                    <div class="flex items-center gap-2">
                        <input type="hidden" class="exam-id" value="<?php echo e($exam->id); ?>">
                        <span class="text-sm font-medium text-gray-900 ms-3 dark:text-gray-300">Activate</span>
                        <label
                            class="relative inline-flex items-center <?php echo e($exam->status == 'progress' ? 'cursor-not-allowed' : 'cursor-pointer'); ?>">
                            <input type="checkbox" value="" class="sr-only peer toggle-switch" id="toggleSwitch"
                                <?php echo e($exam->status == 'progress' ? 'disabled' : ''); ?>

                                <?php echo e($exam->activated == 'yes' ? 'checked' : ''); ?>>
                            <div
                ...
                <div>
                    <div class="mt-5">
                        ...
                        <input type="text" id="base-input" disabled value="<?php echo e($exam->title); ?>"
                    ...
                    <div class="mt-5">
                        <label for="base-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Exam
                            Code</label>
                        <input type="text" id="base-input" disabled value="<?php echo e($exam->code); ?>"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                    <div class="mt-5">
                        ...
                        <input type="text" id="base-input" disabled
                            value="<?php echo e($exam->category == 'ept' ? $exam->eptQuestion->count() : $exam->toeicQuestion->count()); ?>"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                    <div class="pb-5 mt-5 border-b-2 border-gray-200 dark:border-gray-700">
                        <label for="base-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Test
                            Schedules</label>
                        <input type="text" id="base-input" disabled
                            value="<?php echo e('First Date: ' . \Carbon\Carbon::parse($exam->first_date)->translatedFormat('j F Y') . ' (' . $exam->first_time . ' WIB, ' . $exam->second_time . ' WIB, ' . $exam->third_time . ' WIB)'); ?>"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <input type="text" id="base-input" disabled
                            value="<?php echo e('Second Date: ' . \Carbon\Carbon::parse($exam->second_date)->translatedFormat('j F Y') . ' (' . $exam->first_time . ' WIB, ' . $exam->second_time . ' WIB, ' . $exam->third_time . ' WIB)'); ?>"
                        ...
                        <input type="text" id="base-input" disabled
                            value="<?php echo e('Third Date: ' . \Carbon\Carbon::parse($exam->third_date)->translatedFormat('j F Y') . ' (' . $exam->first_time . ' WIB, ' . $exam->second_time . ' WIB, ' . $exam->third_time . ' WIB)'); ?>"
                            class="mt-3 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                    <div class="flex justify-between gap-2 mt-5">
                        <div class="flex gap-2">
                            <a href="<?php echo e($exam->conference_link); ?>" target="_blank"
                            ...
                            <button type="button" id="goButton-<?php echo e($exam->id); ?>"
                                data-modal-target="start-date-modal-<?php echo e($exam->id); ?>"
                                data-modal-toggle="start-date-modal-<?php echo e($exam->id); ?>"
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-4 text-center md:p-5">
                                            ...
                                            <form action="/admin/dashboard/exam/<?php echo e($exam->id); ?>" method="POST">
                                                ...
                                                <?php echo csrf_field(); ?>
                                                <button data-modal-hide="delete-exam-<?php echo e($exam->id); ?>" type="submit"
                                                    class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center me-2">
                                                    Yes, I'm sure
                                                </button>
                                                <button data-modal-hide="delete-exam-<?php echo e($exam->id); ?>" type="button"
            ...
            <div id="start-date-modal-<?php echo e($exam->id); ?>" tabindex="-1"
                class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                <div class="relative w-full max-w-md max-h-full p-4">
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        <button type="button"
                            class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                            data-modal-hide="start-date-modal-<?php echo e($exam->id); ?>">
                        ...
                        <form action="/admin/dashboard/exam/control" method="POST">
                            ...
                            <div class="p-4 text-center md:p-5">
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="mt-2">
                                        <select id="test-date-<?php echo e($exam->id); ?>" required name="date"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                            <option disabled selected>Select the Date</option>
                                            <option value="0">
                                                <?php echo e(\Carbon\Carbon::parse($exam->first_date)->translatedFormat('j F Y')); ?>

                                            </option>
                                            <option value="1">
                                                <?php echo e(\Carbon\Carbon::parse($exam->second_date)->translatedFormat('j F Y')); ?>

                                            </option>
                                            <option value="2">
                                                <?php echo e(\Carbon\Carbon::parse($exam->third_date)->translatedFormat('j F Y')); ?>

                                            </option>
                                        </select>
                                    </div>
                                    <div class="mt-2">
                                        <select id="test-time-<?php echo e($exam->id); ?>" required name="time"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                            <option disabled selected>Select the Time</option>
                                            <option value="0"><?php echo e($exam->first_time); ?> WIB</option>
                                            <option value="1"><?php echo e($exam->second_time); ?> WIB</option>
                                            <option value="2"><?php echo e($exam->third_time); ?> WIB</option>
                                        </select>
                                    </div>
                                    <input type="hidden" name="category" value="<?php echo e($exam->category); ?>">
                                    <input type="hidden" name="exam_code" value="<?php echo e($exam->code); ?>">
                                </div>
                                <button data-modal-hide="start-date-modal-<?php echo e($exam->id); ?>" type="submit"
                                    id="go-button-<?php echo e($exam->id); ?>" disabled
                                ...
                                <button data-modal-hide="start-date-modal-<?php echo e($exam->id); ?>" type="button"
...
<?php echo $__env->make('layouts.adminDashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\zaldy\OneDrive\Documents\All About Widyatama\Semester 7\MBKM\Project\language-test\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>