...
<?php $__env->startSection('content'); ?>
    <form action="/admin/dashboard/exam/ept/story/<?php echo e($story->id); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="flex items-center justify-center">
            <div
                ...
                <div class="border-b-2 border-gray-200 dark:border-gray-700">
                    <h1 class="pb-1 text-2xl font-semibold dark:text-white">EPT Update Story <?php echo e(ucwords($story->section)); ?>

                    </h1>
                </div>
                <?php if($story->section == 'part b' || $story->section == 'part c'): ?>
                    <div class="mt-5">
                        ...
                        <div class="flex gap-1 mt-2 text-sm text-gray-900 dark:text-white">Stored Audio:
                            <div class="text-sm text-blue-800"><?php echo e($story->story); ?></div>
                        </div>
                    </div>
                <?php elseif($story->section == 'reading'): ?>
                    <div class="mt-5">
                        ...
                        <textarea id="reading-story" name="story" rows="4"
                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"><?php echo e($story->story); ?></textarea>
                    </div>
                <?php endif; ?>
                <div class="pb-5 mt-5 border-b-2 border-gray-200 dark:border-gray-700">
                    ...
                    <select id="select-section" name="section" required disabled
                        ...
                        <?php elseif($story->section == 'part c'): ?>
...
<?php echo $__env->make('layouts.adminDashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\zaldy\OneDrive\Documents\All About Widyatama\Semester 7\MBKM\Project\language-test\resources\views/admin/exam/ept/updateStory.blade.php ENDPATH**/ ?>