...
<div class="mt-5">
    <h2 class="pt-3 text-xl font-medium text-gray-900 border-t-2 border-gray-200 dark:border-gray-700 dark:text-white"
        id="partC">Listening Part C
        Directions:</h2>
    <?php if($directions_c): ?>
        <div class="relative p-2 mt-2 border-2 border-gray-200 rounded-lg dark:border-gray-700">
            <?php if($directions_c->audio): ?>
                <audio class="mt-2 mb-2" controls>
                    <source src="<?php echo e(asset('storage/' . $directions_c->audio)); ?>">
                    Your browser does not support the audio element.
                </audio>
            <?php endif; ?>
            <p class="text-base text-gray-900 dark:text-white"><?php echo e($directions_c->direction); ?></p>
            
            <div class="absolute top-3 right-3">
                <button type="button" data-modal-target="delete-direction-<?php echo e($directions_c->id); ?>"
                    data-modal-toggle="delete-direction-<?php echo e($directions_c->id); ?>"
                    data-bs-target="#delete-direction-<?php echo e($directions_c->id); ?>"
                ...
                <a href="/admin/dashboard/exam/ept/direction/<?php echo e($directions_c->id); ?>/edit"
                    onclick="updateLocalStorage('part c')"
                ...
                <div id="delete-direction-<?php echo e($directions_c->id); ?>" tabindex="-1"
                    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                    <div class="relative w-full max-w-md max-h-full p-4">
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            <button type="button"
                                class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                data-modal-hide="delete-direction-<?php echo e($directions_c->id); ?>">
                            ...
                            <div class="p-4 text-center md:p-5">
                                ...
                                <form class="flex justify-center "
                                    action="/admin/dashboard/exam/ept/question/<?php echo e($directions_c->id); ?>" method="POST">
                                    <?php echo method_field('delete'); ?>
                                    <?php echo csrf_field(); ?>
                                    <button data-modal-hide="delete-direction-<?php echo e($directions_c->id); ?>" type="submit"
                                        class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center me-2">
                                        Yes, I'm sure
                                    </button>
                                    <button data-modal-hide="delete-direction-<?php echo e($directions_c->id); ?>" type="button"
...
<div class="mt-3">
    <div class="flex items-center">
        <h2 class="text-xl font-medium text-gray-900 dark:text-white">Question of Listening Part C:</h2>
        <span
            class="inline-flex items-center justify-center w-6 h-6 text-xs font-semibold text-blue-800 bg-blue-200 rounded-full ms-2">
            <?php echo e($questions_c->count()); ?>

        </span>
    </div>
    <?php
        $questionNumber = $countPartC + 1;
    ?>
    <?php if($questions_c->isNotEmpty()): ?>
        <?php $__currentLoopData = $stories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $story): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($story->section == 'part c'): ?>
                ...
                <div class="p-3 mt-2 border-2 border-gray-200 rounded-lg dark:border-gray-700">
                    ...
                    <div class="relative p-2 mt-2 border-2 border-gray-200 rounded-lg dark:border-gray-700">
                        <audio class="mt-2 mb-2" controls>
                            <source src="<?php echo e(asset('storage/' . $story->story)); ?>">
                            Your browser does not support the audio element.
                        </audio>
                        
                        <div class="absolute top-3 right-3">
                            <button type="button" data-modal-target="delete-story-<?php echo e($story->id); ?>"
                                data-modal-toggle="delete-story-<?php echo e($story->id); ?>"
                                data-bs-target="#delete-story-<?php echo e($story->id); ?>"
                                class="inline-flex items-center px-2 py-2 text-sm font-medium text-center text-white bg-white border border-red-200 rounded-lg hover:bg-red-100 focus:ring-4 focus:outline-none focus:ring-red-100 dark:focus:ring-red-600 dark:bg-red-800 dark:border-red-700 dark:text-white dark:hover:bg-red-500">
                            ...
                            <a href="/admin/dashboard/exam/ept/story/<?php echo e($story->id); ?>/edit"
                                onclick="updateLocalStorage('part c')"
                                class="inline-flex items-center px-2 py-2 text-xs font-medium text-center text-white bg-white border border-gray-200 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-100 dark:bg-white dark:focus:ring-gray-700 dark:border-gray-700 dark:text-white dark:hover:bg-gray-200">
                                <svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div id="delete-story-<?php echo e($story->id); ?>" tabindex="-1"
                                class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                <div class="relative w-full max-w-md max-h-full p-4">
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        <button type="button"
                                            class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                            data-modal-hide="delete-story-<?php echo e($story->id); ?>">
                                            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                                fill="none" viewBox="0 0 14 14">
                                        ...
                                        <div class="p-4 text-center md:p-5">
                                            ...
                                            <form class="flex justify-center"
                                                action="/admin/dashboard/exam/ept/story/<?php echo e($story->id); ?>"
                                                method="POST">
                                                <?php echo method_field('delete'); ?>
                                                <?php echo csrf_field(); ?>
                                                <button data-modal-hide="delete-story-<?php echo e($story->id); ?>"
                                                    type="submit"
                                                    class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center me-2">
                                                    Yes, I'm sure
                                                </button>
                        ...
                        <div class="relative p-2 mt-2 border-2 border-gray-200 rounded-lg dark:border-gray-700">
                            <div class="flex gap-5">
                                ...
                                <div class="absolute top-3 right-3">
                                    ...
                                    <a href="/admin/dashboard/exam/ept/question/<?php echo e($question->id); ?>/edit"
                                        onclick="updateLocalStorage('part c')"
                                        class="inline-flex items-center px-2 py-2 text-xs font-medium text-center text-white bg-white border border-gray-200 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-100 dark:bg-white dark:border-gray-700 dark:focus:ring-gray-700 dark:text-white dark:hover:bg-gray-200">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <div class="relative w-full max-w-md max-h-full p-4">
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <div class="p-4 text-center md:p-5">
                                                    ...
                                                    <form class="flex justify-center "
                                                        action="admin/dashboard/exam/ept/question/<?php echo e($question->id); ?>"
                                                        method="POST">
                                                        <?php echo method_field('delete'); ?>
                                                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\zaldy\OneDrive\Documents\All About Widyatama\Semester 7\MBKM\Project\language-test\resources\views/admin/exam/ept/firstSection/partC.blade.php ENDPATH**/ ?>