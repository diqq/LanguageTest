        ...
        <div
            ...
            <div class="mt-5">
                <label for="base-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Exam
                    Code</label>
                <input type="text" id="base-input" disabled value="<?php echo e($examOpen->exam_code); ?>"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            </div>
            <div class="pb-5 mt-5 border-b-2 border-gray-200 dark:border-gray-700">
                <label for="base-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Number
                    of Question</label>
                <input type="text" id="base-input" disabled value="<?php echo e($examOpen->exam->eptQuestion->count()); ?>"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            </div>
            <div class="flex justify-between gap-2 mt-5">
                <div class="flex gap-2">
                    <a href="<?php echo e($examOpen->exam->conference_link); ?>" target="_blank"
                        ...
                        <div class="relative w-full max-w-md max-h-full p-4">
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="p-4 text-center md:p-5">
                                    ...
                                    <form action="/admin/dashboard/exam/control/<?php echo e($examOpen->id); ?>" method="POST">
                                        <?php echo method_field('put'); ?>
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" value="<?php echo e($category); ?>" id="Category">
                                        <input type="hidden" value="<?php echo e($examOpen->id); ?>" id="Exam-Id">
                                        <input type="hidden" value="run" name="status">
                                        <input type="hidden" value="<?php echo e($examOpen->exam->category); ?>" name="category">
                                        <button data-modal-hide="start-modal" type="submit"
                                            onclick="postTimer('<?php echo e($examOpen->id); ?>','<?php echo e($category); ?>')"
            ...
            <div>
                <section class="mt-5">
                    <table id="myTable" class="w-full text-sm text-left text-gray-500 display dark:text-gray-400">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $examOpen->exam->enroll; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enroll): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($enroll->expired == 'no'): ?>
                                    <tr class="border-b bg-gray-50 dark:bg-gray-800 dark:border-gray-700" id="tableRow">
                                        ...
                                        <td class="px-6 py-4">
                                            <img class="object-cover w-10 h-10 rounded-full"
                                                src="<?php echo e(asset('storage/' . $enroll->user->picture)); ?>"
                                                alt="profile_picture">
                                        </td>
                                        <td class="px-6 py-4">
                                            <?php echo e($enroll->user->name); ?>

                                        </td>
                                        <td class="px-6 py-4">
                                            <?php echo e($enroll->user->profile->npm); ?>

                                        </td>
                                        <td class="px-6 py-4">
                                            <?php echo e(ucfirst($enroll->status)); ?>

                                        </td>
                                        <td class="px-6 py-4">
                                            <div>
                                                <button data-modal-target="kick-modal-<?php echo e($enroll->id); ?>"
                                                    data-modal-toggle="kick-modal-<?php echo e($enroll->id); ?>"
                                            ...
                                            <div id="kick-modal-<?php echo e($enroll->id); ?>" tabindex="-1"
                                                class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                                <div class="relative w-full max-w-md max-h-full p-4">
                                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                        <button type="button"
                                                            class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                                            data-modal-hide="kick-modal-<?php echo e($enroll->id); ?>">
                                                        ...
                                                        <div class="p-4 text-center md:p-5">
                                                            ...
                                                            <form
                                                                action="/dashboard/waiting-area/schedule/<?php echo e($enroll->id); ?>"
                                                                method="POST">
                                                                <?php echo method_field('put'); ?>
                                                                <?php echo csrf_field(); ?>
                                                                <input type="hidden" value="kick" name="status">
                                                                <input type="hidden" value="yes" name="expired">
                                                                <button data-modal-hide="kick-modal-<?php echo e($enroll->id); ?>"
                                                                    type="submit"
                                                                    class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center me-2">
                                                                    Yes, I'm sure
                                                                </button>
...
<?php $__env->startPush('script'); ?>
    ...
    <script src="<?php echo e(asset('js/examControl.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.adminDashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\zaldy\OneDrive\Documents\All About Widyatama\Semester 7\MBKM\Project\language-test\resources\views/admin/examControl.blade.php ENDPATH**/ ?>