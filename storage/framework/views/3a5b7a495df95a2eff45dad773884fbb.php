    ...
    <div class="flex justify-center items-center">
        <div
            ...
            <div class="border-b-2 border-gray-200">
                <h1 class="pb-1 text-2xl font-semibold dark:text-white">EPT/TOEIC Upload Question for Listening Part C</h1>
            </div>
            <div class="mt-5">
            ...
            <div class="mt-5 pb-5 border-b-2 border-gray-200">
                ...
                <select id="select-story"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    <option disabled selected>Select Story Part C</option>
                    <option value="">No Story For Part C Has Been Created</option>
                </select>
            </div>
...
<?php echo $__env->make('layouts.adminDashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\zaldy\OneDrive\Documents\All About Widyatama\Semester 7\MBKM\Project\language-test\resources\views/admin/exam/uploadListeningC.blade.php ENDPATH**/ ?>