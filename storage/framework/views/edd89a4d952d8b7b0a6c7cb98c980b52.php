...
<div class="mt-5">
    <h2 class="pt-3 text-xl font-medium text-gray-900 border-t-2 border-gray-200 dark:border-gray-700 dark:text-white"
        ...
        VII:</h2>
    <?php if($directions_vii): ?>
        <div class="relative p-2 mt-2 border-2 border-gray-200 rounded-lg dark:border-gray-700">
            <?php if($directions_vii->audio): ?>
                <audio class="mt-2 mb-2" controls>
                    <source src="<?php echo e(asset('storage/' . $directions_vii->audio)); ?>">
                    Your browser does not support the audio element.
                </audio>
            <?php endif; ?>
            <p class="text-base text-gray-900 dark:text-white"><?php echo e($directions_vii->direction); ?></p>
            
            <div class="absolute top-3 right-3">
                <button type="button" data-modal-target="delete-direction-<?php echo e($directions_vii->id); ?>"
                    data-modal-toggle="delete-direction-<?php echo e($directions_vii->id); ?>"
                    data-bs-target="#delete-direction-<?php echo e($directions_vii->id); ?>"
                ...
                <a href="/admin/dashboard/exam/toeic/direction/<?php echo e($directions_vii->id); ?>/edit"
                    onclick="updateLocalStorage('part vii')"
                ...
                <div id="delete-direction-<?php echo e($directions_vii->id); ?>" tabindex="-1"
                    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                    <div class="relative w-full max-w-md max-h-full p-4">
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            <button type="button"
                                class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                data-modal-hide="delete-direction-<?php echo e($directions_vii->id); ?>">
                            ...
                            <div class="p-4 text-center md:p-5">
                                ...
                                <form class="flex justify-center "
                                    action="/admin/dashboard/exam/toeic/direction/<?php echo e($directions_vii->id); ?>"
                                    method="POST">
                                    <?php echo method_field('delete'); ?>
                                    <?php echo csrf_field(); ?>
                                    <button data-modal-hide="delete-direction-<?php echo e($directions_vii->id); ?>" type="submit"
                                        class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center me-2">
                                        Yes, I'm sure
                                    </button>
                                    <button data-modal-hide="delete-direction-<?php echo e($directions_vii->id); ?>" type="button"
...
<div class="mt-3">
    <div class="flex items-center">
        ...
        <span
            ...
            <?php echo e($questions_vii->count()); ?>
    ...
    ?>
    <?php if($questions_vii->isNotEmpty()): ?>
        <?php $__currentLoopData = $stories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $story): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($story->section == 'vii'): ?>
                <?php
                ...
                <div class="p-3 mt-2 border-2 border-gray-200 rounded-lg dark:border-gray-700">
                    ...
                    <div class="relative p-2 mt-2 border-2 border-gray-200 rounded-lg dark:border-gray-700">
                        <div class="m-2 text-gray-900 dark:text-white"><?php echo $story->story; ?></div>
                        ...
                        <div class="absolute top-3 right-3">
                            ...
                            <a href="/admin/dashboard/exam/toeic/story/<?php echo e($story->id); ?>/edit"
                                onclick="updateLocalStorage('part vii')"
                                class="inline-flex items-center px-2 py-2 text-xs font-medium text-center text-white bg-white border border-gray-200 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-100 dark:bg-white dark:border-gray-700 dark:focus:ring-gray-700 dark:text-white dark:hover:bg-gray-200">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div class="relative w-full max-w-md max-h-full p-4">
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-4 text-center md:p-5">
                                            ...
                                            <form class="flex justify-center "
                                                action="/admin/dashboard/exam/toeic/story/<?php echo e($story->id); ?>"
                                                method="POST">
                                                <?php echo method_field('delete'); ?>
                                                <?php echo csrf_field(); ?>
                            ...
                            <div class="flex gap-5">
                                <div
                                    ...
                                    <?php
                                        $countPartVII++;
                                    ?>
                                    <div><?php echo e($countPartVII); ?>.</div>
                                </div>
                                <div>
                                    <div class="mt-1.5">
                                        <p class="text-base text-gray-900 dark:text-white"><?php echo e($question->question); ?>
...
<?php /**PATH C:\Users\zaldy\OneDrive\Documents\All About Widyatama\Semester 7\MBKM\Project\language-test\resources\views/admin/exam/toeic/reading/partVII.blade.php ENDPATH**/ ?>