        ...
        <div class="flex flex-col items-center justify-center min-h-screen">
            ...
            <div
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-5" method="POST" action="<?php echo e(route('login')); ?>">
                        <?php echo csrf_field(); ?>
                        <div>
                            <label for="email"
...
$message = $__bag->first($__errorArgs[0]); ?>
                                <small
                                    class="text-red-500"><?php echo e($message == 'These credentials do not match our records.' ? 'Your email or password is incorrect. Please try again.' : ''); ?></small>
                            <?php unset($message);
...
<?php /**PATH C:\Users\zaldy\OneDrive\Documents\All About Widyatama\Semester 7\MBKM\Project\language-test\resources\views/auth/login.blade.php ENDPATH**/ ?>