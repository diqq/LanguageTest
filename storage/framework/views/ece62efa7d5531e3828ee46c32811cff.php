                ...
                <div class="p-4 space-y-4 md:p-5">
                            ...
                            <div class="-mt-2">
                                ...
                                <div class="relative max-w-sm">
                                    ...
                                    <input datepicker datepicker-autohide type="text" id="first-date"
                                        ...
                                        value="<?php echo e($exam->first_date); ?>">
                                </div>
                            </div>
                            <div class="mt-5">
                                ...
                                <div class="relative max-w-sm">
                                    ...
                                    <input datepicker datepicker-autohide type="text" id="second-date"
                                        name="second_date"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        value="<?php echo e($exam->second_date); ?>">
                                </div>
                            </div>
                            <div class="mt-5">
                                ...
                                <div class="relative max-w-sm">
                                    ...
                                    <input datepicker datepicker-autohide type="text" id="third-date"
                                        name="third_date"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        value="<?php echo e($exam->third_date); ?>">
                                </div>
                            </div>
                        </div>
                        <div>
                                    ...
                                    <div class="flex items-center gap-1">
                                        <select id="hour" name="hour_1"
                                            ...
                                            <?php for($i = 1; $i <= 24; $i++): ?>
                                                <option value="<?php echo e(sprintf('%02d', $i)); ?>"
                                                    <?php echo e(sprintf('%02d', $i) == substr($exam->first_time, 0, 2) ? 'selected' : ''); ?>>
                                                    <?php echo e(sprintf('%02d', $i)); ?></option>
                                            <?php endfor; ?>
                                        </select>
                                        <div>:</div>
                                        <select id="minute" name="minute_1"
                                            ...
                                            <?php for($i = 15; $i <= 45; $i += 15): ?>
                                                <option value="<?php echo e(sprintf('%02d', $i)); ?>"
                                                    <?php echo e(sprintf('%02d', $i) == substr($exam->first_time, 3, 2) ? 'selected' : ''); ?>>
                                                    <?php echo e(sprintf('%02d', $i)); ?></option>
                                            <?php endfor; ?>
                                        </select>
                                    </div>
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-1">
                                        <select id="hour" name="hour_2"
                                            ...
                                            <?php for($i = 1; $i <= 24; $i++): ?>
                                                <option value="<?php echo e(sprintf('%02d', $i)); ?>"
                                                    <?php echo e(sprintf('%02d', $i) == substr($exam->second_time, 0, 2) ? 'selected' : ''); ?>>
                                                    <?php echo e(sprintf('%02d', $i)); ?></option>
                                            <?php endfor; ?>
                                        </select>
                                        <div>:</div>
                                        <select id="minute" name="minute_2"
                                            ...
                                            <?php for($i = 15; $i <= 45; $i += 15): ?>
                                                <option value="<?php echo e(sprintf('%02d', $i)); ?>"
                                                    <?php echo e(sprintf('%02d', $i) == substr($exam->second_time, 3, 2) ? 'selected' : ''); ?>>
                                                    <?php echo e(sprintf('%02d', $i)); ?></option>
                                            <?php endfor; ?>
                                        </select>
                                    </div>
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-1">
                                        <select id="hour" name="hour_3"
                                            ...
                                            <?php for($i = 1; $i <= 24; $i++): ?>
                                                <option value="<?php echo e(sprintf('%02d', $i)); ?>"
                                                    <?php echo e(sprintf('%02d', $i) == substr($exam->third_time, 0, 2) ? 'selected' : ''); ?>>
                                                    <?php echo e(sprintf('%02d', $i)); ?></option>
                                            <?php endfor; ?>
                                        </select>
                                        <div>:</div>
                                        <select id="minute" name="minute_3"
                                            ...
                                            <?php for($i = 15; $i <= 45; $i += 15): ?>
                                                <option value="<?php echo e(sprintf('%02d', $i)); ?>"
                                                    <?php echo e(sprintf('%02d', $i) == substr($exam->third_time, 3, 2) ? 'selected' : ''); ?>>
                                                    <?php echo e(sprintf('%02d', $i)); ?></option>
                                            <?php endfor; ?>
                                        </select>
                                    </div>
                    ...
                    <div>
                        <label for="conference-input"
                            ...
                            Link</label>
                        <input type="text" id="conference-input" value="<?php echo e($exam->conference_link); ?>"
...
<?php /**PATH C:\Users\zaldy\OneDrive\Documents\All About Widyatama\Semester 7\MBKM\Project\language-test\resources\views/admin/exam/partials/dateModal.blade.php ENDPATH**/ ?>