...
<div class="mt-3">
    <h2 class="text-xl font-medium text-gray-900 dark:text-white" id="structure">Structure Expression Direction:</h2>
    <?php if($directions_structure): ?>
        <div class="relative p-2 mt-2 border-2 border-gray-200 rounded-lg dark:border-gray-700">
            <?php if($directions_structure->audio): ?>
                <audio class="mt-2 mb-2" controls>
                    <source src="<?php echo e(asset('storage/' . $directions_structure->audio)); ?>">
                    Your browser does not support the audio element.
                </audio>
            <?php endif; ?>
            <p class="text-base text-gray-900 dark:text-white"><?php echo e($directions_structure->direction); ?></p>
            
            <div class="absolute top-3 right-3">
                <button type="button" data-modal-target="delete-direction-<?php echo e($directions_structure->id); ?>"
                    data-modal-toggle="delete-direction-<?php echo e($directions_structure->id); ?>"
                    data-bs-target="#delete-direction-<?php echo e($directions_structure->id); ?>"
                ...
                <a href="/admin/dashboard/exam/ept/direction/<?php echo e($directions_structure->id); ?>/edit"
                    onclick="updateLocalStorage('structure')"
                ...
                <div id="delete-direction-<?php echo e($directions_structure->id); ?>" tabindex="-1"
                    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                    <div class="relative w-full max-w-md max-h-full p-4">
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            <button type="button"
                                class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                data-modal-hide="delete-direction-<?php echo e($directions_structure->id); ?>">
                            ...
                            <div class="p-4 text-center md:p-5">
                                ...
                                <form class="flex justify-center "
                                    action="/admin/dashboard/exam/ept/question/<?php echo e($directions_structure->id); ?>"
                                    method="POST">
                                    <?php echo method_field('delete'); ?>
                                    <?php echo csrf_field(); ?>
                                    <button data-modal-hide="delete-direction-<?php echo e($directions_structure->id); ?>"
                                        type="submit"
...
<div class="mt-3">
    <div class="flex items-center">
        <h2 class="text-xl font-medium text-gray-900 dark:text-white">Question of Structure Expression:</h2>
        <span
            class="inline-flex items-center justify-center w-6 h-6 text-xs font-semibold text-blue-800 bg-blue-200 rounded-full ms-2">
            <?php echo e($questions_structure->count()); ?>

        </span>
    </div>
    <?php if($questions_structure->isNotEmpty()): ?>
        <?php $__currentLoopData = $questions_structure; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="relative p-2 mt-2 border-2 border-gray-200 rounded-lg dark:border-gray-700">
                <div class="flex gap-5">
                    <div
                        ...
                        <?php
                            $countStructure++;
                        ?>
                        <div><?php echo e($countStructure); ?>.</div>
                    </div>
                    <div>
                        <div class="mt-1.5">
...
<?php /**PATH C:\Users\zaldy\OneDrive\Documents\All About Widyatama\Semester 7\MBKM\Project\language-test\resources\views/admin/exam/ept/secondSection/structure.blade.php ENDPATH**/ ?>