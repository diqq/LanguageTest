    ...
    <div class="p-5 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <section class="mt-5">
            <table id="myTable" class="w-full text-sm text-left text-gray-500 display dark:text-gray-400">
                ...
                <tbody>
                    <?php if($toeicHistories->isNotEmpty()): ?>
                        <?php $__currentLoopData = $toeicHistories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $toeicHistory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="border-b bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    <?php echo e($toeicHistory->score_listening); ?>

                                </td>
                                <td class="px-6 py-4">
                                    <?php echo e($toeicHistory->score_reading); ?>

                                </td>
                                <td class="px-6 py-4">
                                    <?php echo e($toeicHistory->score_total); ?>

                                </td>
                                <td class="px-6 py-4">
                                    <?php echo e($toeicHistory->created_at->format('Y-m-d')); ?>

                                </td>
                                <td>
                                    <form action="/dashboard/generate/certificate" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" value="<?php echo e($toeicHistory->score_code); ?>" name="score_code">
...
<?php echo $__env->make('layouts.userDashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\zaldy\OneDrive\Documents\All About Widyatama\Semester 7\MBKM\Project\language-test\resources\views/user/testHistoryTOEIC.blade.php ENDPATH**/ ?>