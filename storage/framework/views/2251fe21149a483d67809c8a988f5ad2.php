...
<div id="toeicPartI"
            ...
            <?php if($question->section == 'i'): ?>
                <div class="relative p-2 mt-2 border-2 border-gray-200 rounded-lg dark:border-gray-700">
                    <div class="flex gap-5">
                        ...
                        <div>
                            <div class="mt-1.5">
                                <img class="rounded-lg w-96 h-60" src="<?php echo e(asset('storage/' . $question->photograph)); ?>"
    ...
    <div class="flex justify-end pt-3 mt-5 border-t-2 border-gray-200 dark:border-gray-700">
        <button type="button" onclick="nextToPartII()"
...
<?php /**PATH C:\Users\zaldy\OneDrive\Documents\All About Widyatama\Semester 7\MBKM\Project\language-test\resources\views/examTOEIC/partials/listening/partI.blade.php ENDPATH**/ ?>