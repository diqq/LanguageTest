...
<div id="eptListeningPartC"
    ...
    <div class="border-b-2 border-gray-200 dark:border-gray-700">
        <h1 class="pb-2 text-2xl font-semibold dark:text-white">SECTION ONE - Listening Comperhension Part C</h1>
    </div>

    
    <div class="mt-5">
        <h2 class="pb-2 text-xl font-medium dark:text-white">Direction of Listening Comprehension Part C:</h2>
        <div class="p-3 border-2 border-gray-200 rounded-lg dark:border-gray-700">
            <audio controls>
                <?php $__currentLoopData = $enrolls->exam->eptDirection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $direction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($direction->section == 'part c'): ?>
    ...
    <div class="mt-5">
        <h2 class="pb-2 text-xl font-medium dark:text-white">Question List of Listening Comperhension Part C:</h2>
        <?php
    ...
    <div class="flex items-center justify-between pt-3 mt-5 border-t-2 border-gray-200 dark:border-gray-700">
        <button type="button" onclick="backToListeningPartB()"
        ...
        <button type="button" onclick="nextToStructure()"
...
<?php /**PATH C:\Users\zaldy\OneDrive\Documents\All About Widyatama\Semester 7\MBKM\Project\language-test\resources\views/examEPT/partials/sectionOne/listeningCompPartC.blade.php ENDPATH**/ ?>