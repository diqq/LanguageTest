<?php $__env->startSection('content'); ?>
    <div
        class=" mt-5 p-5 max-w-screen-lg mx-auto bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <div class="border-b-2 border-gray-200">
            <h1 class="pb-2 text-xl font-semibold dark:text-white">Contact Us</h1>
        </div>
        <section class="mt-5">
            <div>Phone Number : <a class="text-blue-800"
                    ...
                    target="_blank">(+62)
                    821-1841-2164</a></div>
            <div>E-Mail Address : <a class="text-blue-800"
                    href="mailto:lembaga.bahasa@widyatama.ac.id">lembaga.bahasa@widyatama.ac.id</a></div>
            <div>Main Website : <a class=" text-blue-800" href="https://lembagabahasa.widyatama.ac.id/">
                    https://lembagabahasa.widyatama.ac.id/</a>
            </div>
            <div>Street Address : Jl. Cikutra no 204 A Bandung Jawa Barat, Indonesia 40124</div>
            <iframe class="mt-5 rounded-lg w-full"
...
<?php echo $__env->make('layouts.userDashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\zaldy\OneDrive\Documents\All About Widyatama\Semester 7\MBKM\Project\language-test\resources\views/pages/contact-us.blade.php ENDPATH**/ ?>