    ...
    <div class="flex justify-center items-center">
        <div
            ...
            <div class="border-b-2 border-gray-200">
                <h1 class="pb-1 text-2xl font-semibold dark:text-white">EPT/TOEIC Upload Question for Structure Expression
                </h1>
            </div>
            <div class="mt-5">
...
<?php echo $__env->make('layouts.adminDashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\zaldy\OneDrive\Documents\All About Widyatama\Semester 7\MBKM\Project\language-test\resources\views/admin/exam/uploadStructureEx.blade.php ENDPATH**/ ?>