...
<?php $__env->startSection('content'); ?>
    <form action="/admin/dashboard/exam/toeic/story/<?php echo e($story->id); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="flex items-center justify-center">
            <div
                ...
                <?php elseif($story->section == 'vii'): ?>
                    <div class="mt-5" id="rich-text">
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                            for="editor">Story</label>
                        <textarea id="editor" name="story"><?php echo e($story->story); ?></textarea>
                    </div>
                <?php endif; ?>
                <div class="pb-5 mt-5 border-b-2 border-gray-200 dark:border-gray-700">
                    ...
                    <select id="select-section" name="section" required disabled
                        ...
                        <?php elseif($story->section == 'vii'): ?>
                            <option value="vii" selected>Reading Part VII</option>
                        <?php endif; ?>
                    </select>
                </div>
...
<?php echo $__env->make('layouts.adminDashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\zaldy\OneDrive\Documents\All About Widyatama\Semester 7\MBKM\Project\language-test\resources\views/admin/exam/toeic/updateStory.blade.php ENDPATH**/ ?>