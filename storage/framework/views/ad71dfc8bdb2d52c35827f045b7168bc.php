...
<div class="mt-5">
    <h2 class="pt-3 text-xl font-medium text-gray-900 border-t-2 border-gray-200 dark:border-gray-700 dark:text-white"
        id="partIII">Direction of Listening
        Part III:</h2>
    <?php if($directions_iii): ?>
        <div class="relative p-2 mt-2 border-2 border-gray-200 rounded-lg dark:border-gray-700">
            <?php if($directions_iii->audio): ?>
                <audio class="mt-2 mb-2" controls>
                    <source src="<?php echo e(asset('storage/' . $directions_iii->audio)); ?>">
                    Your browser does not support the audio element.
                </audio>
            <?php endif; ?>
            <p class="text-base text-gray-900 dark:text-white"><?php echo e($directions_iii->direction); ?></p>
            
            <div class="absolute top-3 right-3">
                <button type="button" data-modal-target="delete-direction-<?php echo e($directions_iii->id); ?>"
                    data-modal-toggle="delete-direction-<?php echo e($directions_iii->id); ?>"
                    data-bs-target="#delete-direction-<?php echo e($directions_iii->id); ?>"
                ...
                <a href="/admin/dashboard/exam/toeic/direction/<?php echo e($directions_iii->id); ?>/edit"
                    onclick="updateLocalStorage('part iii')"
                ...
                <div id="delete-direction-<?php echo e($directions_iii->id); ?>" tabindex="-1"
                    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                    <div class="relative w-full max-w-md max-h-full p-4">
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            <button type="button"
                                class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                data-modal-hide="delete-direction-<?php echo e($directions_iii->id); ?>">
                            ...
                            <div class="p-4 text-center md:p-5">
                                ...
                                <form class="flex justify-center "
                                    action="/admin/dashboard/exam/toeic/direction/<?php echo e($directions_iii->id); ?>"
                                    method="POST">
                                    <?php echo method_field('delete'); ?>
                                    <?php echo csrf_field(); ?>
                                    <button data-modal-hide="delete-direction-<?php echo e($directions_iii->id); ?>" type="submit"
                                        class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center me-2">
                                        Yes, I'm sure
                                    </button>
                                    <button data-modal-hide="delete-direction-<?php echo e($directions_iii->id); ?>" type="button"
...
<div class="mt-3">
    <div class="flex items-center">
        <h2 class="text-xl font-medium text-gray-900 dark:text-white">Question of Listening Part III:</h2>
        <span
            class="inline-flex items-center justify-center w-6 h-6 text-xs font-semibold text-blue-800 bg-blue-200 rounded-full ms-2">
            <?php echo e($questions_iii->count()); ?>

        </span>
    </div>
    <?php if($questions_iii->isNotEmpty()): ?>
        <?php $__currentLoopData = $questions_iii; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="relative p-2 mt-2 border-2 border-gray-200 rounded-lg dark:border-gray-700">
                <div class="flex gap-5">
                    <div
                        ...
                        <?php
                            $countPartIII++;
                        ?>
                        <div><?php echo e($countPartIII); ?>.</div>
                    </div>
                    <div>
                        <div class="mt-1.5">
                            <audio class="-mt-1.5" controls>
                                <source src="<?php echo e(asset('storage/' . $question->audio)); ?>">
                                Your browser does not support the audio element.
                            </audio>
...
<?php /**PATH C:\Users\zaldy\OneDrive\Documents\All About Widyatama\Semester 7\MBKM\Project\language-test\resources\views/admin/exam/toeic/listening/partIII.blade.php ENDPATH**/ ?>