...
<head>
    ...
    <title>Forgot Password | Language Institute - Widyatama University</title>
</head>
            ...
            <div
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    <div class="flex flex-col items-center justify-center">
                        ...
                        <small class="mt-1 text-sm text-center text-gray-900 dark:text-white">Please Input your email in
                            form below, and we'll send you an email for making a new password.</small>
                    </div>
                    <form class="space-y-4 md:space-y-6" method="POST" action="<?php echo e(route('password.email')); ?>">
                        <?php echo csrf_field(); ?>
                        <div>
                            <small class="text-blue-800"><?php echo e(session('status')); ?></small>
                            <label for="email"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <button type="submit"
                            class="w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Send</button>
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            Back to Sign in? <a href="/"
                                class="font-medium text-blue-600 hover:underline dark:text-blue-500">Click here!</a>
                        </p>
                    </form>
                </div>
            </div>
...
<?php /**PATH C:\Users\zaldy\OneDrive\Documents\All About Widyatama\Semester 7\MBKM\Project\language-test\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>