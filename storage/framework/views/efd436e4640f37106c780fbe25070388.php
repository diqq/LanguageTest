...
<?php $__env->startSection('content'); ?>
    <form action="/admin/dashboard/exam/toeic/question/<?php echo e($questions->id); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div
                ...
                <div class="border-b-2 border-gray-200 dark:border-gray-700">
                    <h1 class="pb-1 text-2xl font-semibold text-gray-900 dark:text-white">TOEIC Update Question Part
                        <?php echo e(strtoupper($questions->section)); ?></h1>
                </div>
                <?php if($questions->section == 'i'): ?>
                    <div class="mt-5">
                        ...
                        <div class="flex gap-1 mt-2 text-sm text-gray-900 dark:text-white">Stored Photograph:
                            <div class="text-sm text-blue-800"><?php echo e($questions->photograph); ?></div>
                        </div>
                    </div>
                    <div class="mt-5">
                    ...
                    <div class="flex gap-1 mt-2 text-sm text-gray-900 dark:text-white">Stored Audio:
                        <div class="text-sm text-blue-800"><?php echo e($questions->audio); ?></div>
                    </div>
                <?php elseif($questions->section == 'ii'): ?>
                    <div class="mt-5">
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="file_input">Audio
                            Question</label>
                        <input id="file_input" type="file" name="audio" accept="audio/*"
                ...
                <?php elseif($questions->section == 'iii'): ?>
                    <div class="mt-5">
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="file_input">Audio
                            Conversation</label>
                        <input id="file_input" type="file" name="audio" accept="audio/*"
                    ...
                    <div class="mt-5">
                        ...
                        <input id="text-input" type="text" name="question" value="<?php echo e($questions->question); ?>" required
                ...
                <?php elseif($questions->section == 'iv'): ?>
                    <div class="mt-5">
                        ...
                        <select id="select-story" name="story_code" required
                            ...
                            <?php $__currentLoopData = $stories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $story): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($story->section == 'iv'): ?>
                                    <option value="<?php echo e($story->story); ?>"
                ...
                <?php elseif($questions->section == 'v' || $questions->section == 'vi'): ?>
                    <div class="mt-5">
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                            for="text-input">Question</label>
                        <textarea id="text-input" name="question" rows="5" value="<?php echo e($questions->question); ?>" required
                ...
                <?php elseif($questions->section == 'vii'): ?>
                    <div class="mt-5">
                        <label for="select-story"
                            class="block mt-5 mb-2 text-sm font-medium text-gray-900 dark:text-white">Select
                        ...
                        <select id="select-story" name="story_code" required
                            ...
                            <?php $__currentLoopData = $stories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $story): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($story->section == 'vii'): ?>
                                    <option value="<?php echo e($story->story); ?>"
                                        <?php echo e($story->code == $questions->story_code ? 'selected' : ''); ?>>
                ...
                <?php elseif($questions->section === 'v'): ?>
                    <input type="hidden" value="5" name="questionCase">
                <?php elseif($questions->section === 'vi'): ?>
...
<?php echo $__env->make('layouts.adminDashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\zaldy\OneDrive\Documents\All About Widyatama\Semester 7\MBKM\Project\language-test\resources\views/admin/exam/toeic/updateQuestion.blade.php ENDPATH**/ ?>