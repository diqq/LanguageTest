...
<div class="mt-3">
    <h2 class="text-xl font-medium text-gray-900 dark:text-white" id="partA">Listening Part A Directions:</h2>
    <?php if($directions_a): ?>
        <div class="relative p-2 mt-2 border-2 border-gray-200 rounded-lg dark:border-gray-700">
            ...
            <?php endif; ?>
            <p class="text-base text-gray-900 dark:text-white"><?php echo e($directions_a->direction); ?></p>
            
            <div class="absolute top-3 right-3">
                <button type="button" data-modal-target="delete-direction-<?php echo e($directions_a->id); ?>"
                    data-modal-toggle="delete-direction-<?php echo e($directions_a->id); ?>"
                    data-bs-target="#delete-direction-<?php echo e($directions_a->id); ?>"
                ...
                <a href="/admin/dashboard/exam/ept/direction/<?php echo e($directions_a->id); ?>/edit"
                ...
                <div id="delete-direction-<?php echo e($directions_a->id); ?>" tabindex="-1"
                    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                    <div class="relative w-full max-w-md max-h-full p-4">
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            <button type="button"
                                class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                data-modal-hide="delete-direction-<?php echo e($directions_a->id); ?>">
                            ...
                            <div class="p-4 text-center md:p-5">
                                ...
                                <form class="flex justify-center "
                                    action="/admin/dashboard/exam/ept/direction/<?php echo e($directions_a->id); ?>" method="POST">
                                    <?php echo method_field('delete'); ?>
                                    <?php echo csrf_field(); ?>
                                    <button data-modal-hide="delete-direction-<?php echo e($directions_a->id); ?>" type="submit"
                                        class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center me-2">
                                        Yes, I'm sure
                                    </button>
                                    <button data-modal-hide="delete-direction-<?php echo e($directions_a->id); ?>" type="button"
    ...
    <?php else: ?>
        <div class="p-2 mt-2 text-gray-900 border-2 border-gray-200 rounded-lg dark:border-gray-700 dark:text-white">
...
<div class="mt-3">
    <div class="flex items-center">
        <h2 class="text-xl font-medium text-gray-900 dark:text-white">Question of Listening Part A:</h2>
        <span
            class="inline-flex items-center justify-center w-6 h-6 text-xs font-semibold text-blue-800 bg-blue-200 rounded-full ms-2">
            <?php echo e($questions_a->count()); ?>

        </span>
    </div>
    <?php if($questions_a->isNotEmpty()): ?>
        <?php $__currentLoopData = $questions_a; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="relative p-2 mt-2 border-2 border-gray-200 rounded-lg dark:border-gray-700">
                <div class="flex gap-5">
                    ...
                    <div class="absolute top-3 right-3">
                        ...
                        <a href="/admin/dashboard/exam/ept/question/<?php echo e($question->id); ?>/edit"
                            onclick="updateLocalStorage('part a')"
                            class="inline-flex items-center px-2 py-2 text-xs font-medium text-center text-white bg-white border border-gray-200 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-100 dark:bg-white dark:border-gray-700 dark:text-white dark:focus:ring-gray-700 dark:hover:bg-gray-200">
                            <svg xmlns="http://www.w3.org/2000/svg"
...
<?php /**PATH C:\Users\zaldy\OneDrive\Documents\All About Widyatama\Semester 7\MBKM\Project\language-test\resources\views/admin/exam/ept/firstSection/partA.blade.php ENDPATH**/ ?>