...
<div class="mt-3">
    ...
    <?php if($directions_reading): ?>
        <div class="relative p-2 mt-2 border-2 border-gray-200 rounded-lg dark:border-gray-700">
            <?php if($directions_reading->audio): ?>
                <audio class="mt-2 mb-2" controls>
                    <source src="<?php echo e(asset('storage/' . $directions_reading->audio)); ?>">
                    Your browser does not support the audio element.
                </audio>
            <?php endif; ?>
            <p class="text-base text-gray-900 dark:text-white"><?php echo e($directions_reading->direction); ?></p>
            
            <div class="absolute top-3 right-3">
                <button type="button" data-modal-target="delete-direction-<?php echo e($directions_reading->id); ?>"
                    data-modal-toggle="delete-direction-<?php echo e($directions_reading->id); ?>"
                    data-bs-target="#delete-direction-<?php echo e($directions_reading->id); ?>"
                ...
                <a href="/admin/dashboard/exam/ept/direction/<?php echo e($directions_reading->id); ?>/edit"
                ...
                <div id="delete-direction-<?php echo e($directions_reading->id); ?>" tabindex="-1"
                    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                    <div class="relative w-full max-w-md max-h-full p-4">
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            <button type="button"
                                class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                data-modal-hide="delete-direction-<?php echo e($directions_reading->id); ?>">
                            ...
                            <div class="p-4 text-center md:p-5">
                                ...
                                <form class="flex justify-center "
                                    action="/admin/dashboard/exam/ept/question/<?php echo e($directions_reading->id); ?>"
                                    method="POST">
                                    <?php echo method_field('delete'); ?>
                                    <?php echo csrf_field(); ?>
                                    <button data-modal-hide="delete-direction-<?php echo e($directions_reading->id); ?>"
                                        type="submit"
...
<div class="mt-3">
    <div class="flex items-center">
        ...
        <span
            ...
            <?php echo e($questions_reading->count()); ?>
    ...
    ?>
    <?php if($questions_reading->isNotEmpty()): ?>
            ...
            <?php if($story->section == 'reading'): ?>
                ...
                <div class="p-3 mt-2 border-2 border-gray-200 rounded-lg dark:border-gray-700">
                    ...
                    <div class="relative p-3 mt-2 border-2 border-gray-200 rounded-lg dark:border-gray-700">
                        <p class="mt-2 mb-3 text-gray-900 dark:text-white"><?php echo e($story->story); ?></p>
                            ...
                            <div class="flex gap-5">
                                <div
                                    ...
                                    <?php
                                        $countReading++;
                                    ?>
                                    <div><?php echo e($countReading); ?>.</div>
                                </div>
                                <div>
                                    <div class="mt-1.5">
...
<?php /**PATH C:\Users\zaldy\OneDrive\Documents\All About Widyatama\Semester 7\MBKM\Project\language-test\resources\views/admin/exam/ept/thirdSection/reading.blade.php ENDPATH**/ ?>