<?php $__env->startSection('content'); ?>
    <form action="/admin/dashboard/exam/ept/direction/<?php echo e($direction->id); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="flex items-center justify-center">
            <div
                ...
                <div class="border-b-2 border-gray-200 dark:border-gray-700">
                    <h1 class="pb-1 text-2xl font-semibold dark:text-white">EPT Update Direction
                        <?php echo e(ucwords($direction->section)); ?>
                ...
                <div class="pb-5 mt-5 border-b-2 border-gray-200 dark:border-gray-700">
                    ...
                    <select id="select-section" name="section" required disabled
                        ...
                        <option value="part a" <?php echo e($direction->section == 'part a' ? 'selected' : ''); ?>>Listening
                            Comperhension
                            Part A</option>
                        <option value="part b" <?php echo e($direction->section == 'part b' ? 'selected' : ''); ?>>Listening
                            Comperhension Part B</option>
                        <option value="part c"<?php echo e($direction->section == 'part c' ? 'selected' : ''); ?>>Listening
                            Comperhension Part C</option>
                        <option value="structure"<?php echo e($direction->section == 'structure' ? 'selected' : ''); ?>>Structure
                            Expression</option>
                        <option value="written"<?php echo e($direction->section == 'written' ? 'selected' : ''); ?>>Written Expression
                        </option>
                        <option value="reading"<?php echo e($direction->section == 'reading' ? 'selected' : ''); ?>>Reading
...
<?php echo $__env->make('layouts.adminDashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\zaldy\OneDrive\Documents\All About Widyatama\Semester 7\MBKM\Project\language-test\resources\views/admin/exam/ept/updateDirection.blade.php ENDPATH**/ ?>