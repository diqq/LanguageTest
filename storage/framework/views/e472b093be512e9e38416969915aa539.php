...
<div id="toeicPartIV"
    ...
    <div class="border-b-2 border-gray-200 dark:border-gray-700">
        <h1 class="pb-2 text-2xl font-semibold dark:text-white">PART IV - Listening</h1>
    </div>
    
    <div class="mt-5">
        <h2 class="pb-2 text-xl font-medium dark:text-white">Direction of Listening Part IV:</h2>
    ...
    <div class="mt-5">
        ...
        ?>
        <?php $__currentLoopData = $enrolls->exam->toeicStory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $story): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div>
                                    ...
                                    <form class="mt-3 ms-1">
                                        <div class="flex items-center mb-4">
                                            <input id="toeic-answer-<?php echo e($question->id); ?>-a" type="radio"
                                                value="a" name="answer"
                                        ...
                                        <div class="flex items-center mb-4">
                                            <input id="toeic-answer-<?php echo e($question->id); ?>-b" type="radio"
                                                value="b" name="answer"
                                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                        ...
                                        <div class="flex items-center mb-4">
                                            <input id="toeic-answer-<?php echo e($question->id); ?>-c" type="radio"
                                                value="c" name="answer"
                                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                        ...
                                        <div class="flex items-center mb-1">
                                            <input id="toeic-answer-<?php echo e($question->id); ?>-d" type="radio"
                                                value="d" name="answer"
                                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
    ...
    <div class="flex items-center justify-between pt-3 mt-5 border-t-2 border-gray-200 dark:border-gray-700">
        <button type="button" onclick="backToPartIII()"
        ...
        <button type="button" onclick="nextToPartV()"
...
<?php /**PATH C:\Users\zaldy\OneDrive\Documents\All About Widyatama\Semester 7\MBKM\Project\language-test\resources\views/examTOEIC/partials/listening/partIV.blade.php ENDPATH**/ ?>