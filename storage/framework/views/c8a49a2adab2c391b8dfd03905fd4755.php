...
<?php $__env->startSection('content'); ?>
    <form action="/admin/dashboard/exam/toeic/direction" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="flex items-center justify-center">
            <div
                ...
                <div class="border-b-2 border-gray-200 dark:border-gray-700">
                    <h1 class="pb-1 text-2xl font-semibold dark:text-white">TOEIC Upload Direction</h1>
                </div>
                <div class="mt-5">
                ...
                <div class="pb-5 mt-5 border-b-2 border-gray-200 dark:border-gray-700">
                    ...
                    <select id="select-section" name="section" required
                        ...
                        <optgroup label="Listening Comperhension Section">
                            ...
                            <option value="iv">Part IV</option>
                        </optgroup>
                        <optgroup label="Reading Comperhension Section">
                            <option value="v">Part V</option>
                            <option value="vi">Part VI</option>
                            <option value="vii">Part VII</option>
                        </optgroup>
                    </select>
                </div>
...
<?php echo $__env->make('layouts.adminDashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\zaldy\OneDrive\Documents\All About Widyatama\Semester 7\MBKM\Project\language-test\resources\views/admin/exam/toeic/uploadDirection.blade.php ENDPATH**/ ?>