...
<div id="eptStructure"
    ...
    <div class="border-b-2 border-gray-200 dark:border-gray-700">
        <h1 class="pb-2 text-2xl font-semibold dark:text-white">SECTION TWO - Structure Expression</h1>
    </div>
        ...
        <div class="p-3 border-2 border-gray-200 rounded-lg dark:border-gray-700">
            <audio controls>
                <?php $__currentLoopData = $enrolls->exam->eptDirection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $direction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($direction->section == 'structure'): ?>
            ...
            <?php if($question->section == 'structure'): ?>
                <div class="p-3 mb-3 border-2 border-gray-200 rounded-lg dark:border-gray-700">
                    <div class="flex gap-5">
                        ...
                        <div>
                            <p class="mt-2"><?php echo e($question->question); ?></p>
                            <form>
    ...
    <div class="flex items-center justify-between pt-3 mt-5 border-t-2 border-gray-200 dark:border-gray-700">
        <button type="button" onclick="backToListeningPartC()"
        ...
        <button type="button" onclick="nextToWritten()"
...
<?php /**PATH C:\Users\zaldy\OneDrive\Documents\All About Widyatama\Semester 7\MBKM\Project\language-test\resources\views/examEPT/partials/sectionTwo/structureExpression.blade.php ENDPATH**/ ?>