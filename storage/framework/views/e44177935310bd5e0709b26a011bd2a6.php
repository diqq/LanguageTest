<?php $__env->startSection('content'); ?>
    <form action="/admin/dashboard/manage-users/update/<?php echo e($user->id); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div
            ...
            <div class="mt-5">
                <div class="flex justify-center mb-5">
                    <img class="object-cover rounded-full w-52 h-52 bg-gray-50" src="<?php echo e(asset('storage/' . $user->picture)); ?>"
                        alt="profile-picture">
                </div>
                    ...
                    <div class="w-3/4">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" id="npm" name="npm"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                value="<?php echo e($user->profile->npm); ?>">
                        </div>
                        <div class="mb-5">
                            <label for="faculty"
                            ...
                            <input type="text" id="faculty" name="faculty"
                                ...
                                value="<?php echo e($user->profile->faculty); ?>" disabled>
                        </div>
                        <div class="mb-5">
                            ...
                            <input type="text" id="program_study" name="program_study"
                                class="bg-gray-50 cursor-not-allowed border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                value="<?php echo e($user->profile->program_study); ?>" disabled>
                        </div>
                        <div class="mb-5">
                            <label for="email"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email</label>
                            <input type="email" id="email" id="disabled-input" aria-label="disabled input"
                                class="bg-gray-50 cursor-not-allowed border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="<?php echo e($user->email); ?>" disabled>
                        </div>
                        <div class="mb-5">
                            <label for="created"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Account
                                Created</label>
                            <input type="text" id="created" id="disabled-input" aria-label="disabled input"
                                class="bg-gray-50 cursor-not-allowed border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="<?php echo e($user->email_verified_at->format('Y-m-d')); ?>" disabled>
                        </div>
                        <div class="mb-5 border-b-2 border-gray-200 dark:border-gray-700">
                            <div class="pb-5">
                                ...
                                <input type="text" id="registrant"
                                    class="bg-gray-50 cursor-not-allowed border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="<?php echo e(ucwords(strtolower($user->profile->registrant))); ?>" disabled>
                            </div>
                        </div>
                        <div>
                            <button type="button" data-modal-target="save-changes" data-modal-toggle="save-changes"
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-4 text-center md:p-5">
                                            ...
                                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you
                                                sure you want to change this Profile Data?</h3>
                                            <button data-modal-hide="save-changes" type="submit"
                                            ...
                                            <button data-modal-hide="save-changes" type="button"
...
<?php echo $__env->make('layouts.adminDashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\zaldy\OneDrive\Documents\All About Widyatama\Semester 7\MBKM\Project\language-test\resources\views/admin/updateUser.blade.php ENDPATH**/ ?>