...
<div id="toeicPartIII"
    ...
    <div class="border-b-2 border-gray-200 dark:border-gray-700">
        <h1 class="pb-2 text-2xl font-semibold dark:text-white">PART III - Listening</h1>
    </div>
    
    <div class="mt-5">
        <h2 class="pb-2 text-xl font-medium dark:text-white">Direction of Listening Part III:</h2>
                    ...
                    <div class="flex gap-5">
                        ...
                        <div>
                            <div class="mt-1.5">
                                ...
                                <p class="mt-1.5 text-base text-gray-900 dark:text-white"><?php echo e($question->question); ?></p>
                            </div>
    ...
    <div class="flex items-center justify-between pt-3 mt-5 border-t-2 border-gray-200 dark:border-gray-700">
        <button type="button" onclick="backToPartII()"
        ...
        <button type="button" onclick="nextToPartIV()"
...
<?php /**PATH C:\Users\zaldy\OneDrive\Documents\All About Widyatama\Semester 7\MBKM\Project\language-test\resources\views/examTOEIC/partials/listening/partIII.blade.php ENDPATH**/ ?>