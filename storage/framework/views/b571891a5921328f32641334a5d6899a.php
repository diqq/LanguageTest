    ...
    <div class="p-5 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <section class="mt-5">
            <table id="myTable" class="w-full text-sm text-left text-gray-500 display dark:text-gray-400">
                ...
                <tbody>
                    <?php $__currentLoopData = $getUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $getUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="border-b bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td scope="row" class="px-6 py-4">
                                <?php echo e($getUser->name); ?>

                            </td>
                            <td scope="row" class="px-6 py-4">
                                <?php echo e($getUser->profile->npm); ?>

                            </td>
                            <td scope="row" class="px-6 py-4">
                                <?php echo e($getUser->profile->faculty); ?>

                            </td>
                            <td scope="row" class="px-6 py-4">
                                <?php echo e($getUser->profile->program_study); ?>

                            </td>
                            <td scope="row" class="px-6 py-4">
                                <?php echo e($getUser->email_verified_at->format('Y-m-d')); ?>

                            </td>
                            <td scope="row" class="px-6 py-4">
                                <div>
                                    <button type="button" data-modal-target="delete-user-<?php echo e($getUser->id); ?>"
                                        data-modal-toggle="delete-user-<?php echo e($getUser->id); ?>"
                                        data-bs-target="#delete-user-<?php echo e($getUser->id); ?>"
                                    ...
                                    <div id="delete-user-<?php echo e($getUser->id); ?>" tabindex="-1"
                                        class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                        <div class="relative w-full max-w-md max-h-full p-4">
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                <button type="button"
                                                    class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                                    data-modal-hide="delete-user-<?php echo e($getUser->id); ?>">
                                                ...
                                                <form action="/admin/dashboard/manage-users/delete/<?php echo e($getUser->id); ?>"
                                                    method="POST">
                                                    ...
                                                    <div class="p-4 text-center md:p-5">
                                                        ...
                                                        <button data-modal-hide="delete-user-<?php echo e($getUser->id); ?>"
                                                            type="submit"
                                    ...
                                    <a href="/admin/dashboard/manage-users/edit/<?php echo e($getUser->id); ?>"
...
<?php echo $__env->make('layouts.adminDashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\zaldy\OneDrive\Documents\All About Widyatama\Semester 7\MBKM\Project\language-test\resources\views/admin/manageUser.blade.php ENDPATH**/ ?>