        ...
        <div class="p-3 border-2 border-gray-200 rounded-lg dark:border-gray-700">
            <audio controls>
                <?php $__currentLoopData = $enrolls->exam->eptDirection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $direction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($direction->section == 'reading'): ?>
        ...
        <?php $__currentLoopData = $enrolls->exam->eptStory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $story): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($story->section == 'reading'): ?>
                ...
                <div class="p-3 mb-5 border-2 border-gray-200 rounded-lg dark:border-gray-700">
                    ...
                    <?php endif; ?>
                    <p class="p-2.5 mt-1.5 border-2 border-gray-200 rounded-lg dark:border-gray-700"><?php echo e($story->story); ?>
...
<?php /**PATH C:\Users\zaldy\OneDrive\Documents\All About Widyatama\Semester 7\MBKM\Project\language-test\resources\views/examEPT/partials/sectionThree/readingComp.blade.php ENDPATH**/ ?>