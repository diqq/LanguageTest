<?php $__env->startSection('content'); ?>
    <form action="/admin/dashboard/exam/ept/story" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="flex items-center justify-center">
            <div
                ...
                <div class="border-b-2 border-gray-200 dark:border-gray-700">
                    <h1 class="pb-1 text-2xl font-semibold dark:text-white">EPT Upload Story</h1>
                </div>
...
<?php $__env->startPush('script'); ?>
    <script src="<?php echo e(asset('js/eptUploadStory.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.adminDashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\zaldy\OneDrive\Documents\All About Widyatama\Semester 7\MBKM\Project\language-test\resources\views/admin/exam/ept/uploadStory.blade.php ENDPATH**/ ?>