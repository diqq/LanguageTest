...
@section('content')
    <form action="/admin/dashboard/exam/toeic/direction/{{ $direction->id }}" method="POST" enctype="multipart/form-data">
        @method('put')
        @csrf
            ...
            <div
                ...
                <div class="pb-5 mt-5 border-b-2 border-gray-200 dark:border-gray-700">
                    ...
                    <select id="select-section" name="section" disabled required
                        ...
                        <option value="i" {{ $direction->section == 'i' ? 'selected' : '' }}>Part I</option>
                        <option value="ii" {{ $direction->section == 'ii' ? 'selected' : '' }}>Part II</option>
                        <option value="iii" {{ $direction->section == 'iii' ? 'selected' : '' }}>Part III</option>
                        <option value="iv" {{ $direction->section == 'iv' ? 'selected' : '' }}>Part IV</option>
                        <option value="v" {{ $direction->section == 'v' ? 'selected' : '' }}>Part V</option>
                        <option value="vi" {{ $direction->section == 'vi' ? 'selected' : '' }}>Part VI</option>
                        <option value="vii" {{ $direction->section == 'vii' ? 'selected' : '' }}>Part VII</option>
                    </select>
                </div>
