            ...
            <div
                ...
                <div class="mt-5">
                    <select id="date" name="date"
                        ...
                        <option value="0">
                            {{ \Carbon\Carbon::parse($exams->first_date)->translatedFormat('j F Y') }}</option>
                        <option value="1">
                            {{ \Carbon\Carbon::parse($exams->second_date)->translatedFormat('j F Y') }}</option>
                        <option value="2">
                            {{ \Carbon\Carbon::parse($exams->third_date)->translatedFormat('j F Y') }}</option>
                    </select>
                </div>
                <div class="mt-5">
                    <select id="time" name="time"
                        ...
                        <option value="0">{{ $exams->first_time }} WIB</option>
                        <option value="1">{{ $exams->second_time }} WIB</option>
                        <option value="2">{{ $exams->third_time }} WIB</option>
                    </select>
                </div>
