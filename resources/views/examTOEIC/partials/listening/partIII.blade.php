...
<div id="toeicPartIII"
    ...
    {{-- Direction of Part III - Listening --}}
    <div class="mt-5">
    ...
    {{-- Question of Part III - Listening --}}
    <div class="mt-5">
                        ...
                        <div>
                            <div class="mt-1.5">
                                ...
                                <audio id="audioQuestionSource-{{ $question->id }}"
                                    src="{{ asset('storage/' . $question->audio) }}"></audio>
                                <p class="mt-1.5 text-base text-gray-900 dark:text-white">{{ $question->question }}</p>
                            </div>
                            {{-- Answer --}}
